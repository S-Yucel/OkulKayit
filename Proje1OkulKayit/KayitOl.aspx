                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="Index.aspx" class="drop-text">Etkinlikler</a></li>
                                    <li><a href="Index.aspx" class="drop-text">Biz Neler Yaptık?</a></li>
                                    <li><a href="Index.aspx" class="drop-text">Popüler Kurslar</a></li>
                                    <li><a href="Index.aspx" class="drop-text">İstatistikler</a></li>
                                    <li><a href="Index.aspx" class="drop-text">Galeri</a></li>
                                </ul>
                            </li>
